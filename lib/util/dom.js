...
module.exports = {
  ...
  hostedFieldHtml: hostedFieldHtml,
...
/**
 * Utility function to generate injectable html for a hosted field
 * @param  {String} classList
 * @params {String} url
 * @return {String} html
 */

function hostedFieldHtml (classList = [], url = '') {
  let html;

  if (this.isMobile()) {
    html = `
      <div class="${classList}">
        ${this.createHiddenInput().outerHTML}
        <iframe
          src="${url}"
          border="0"
          frameborder="0"
